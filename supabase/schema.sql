-- =====================================================
-- NEXO-SST · Schema Completo para Supabase
...
-- 2) TABELA DE PERFIS (linked to auth.users)
...
-- 8) TABELA DE CONVITES (Sistema de convite com validação biométrica)
...
-- Permite leitura pública de convites (para a página de cadastro por link)
